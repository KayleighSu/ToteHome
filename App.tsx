...
function Settings({ household, totes, email, profile, labelSize, setLabelSize, openTote, sendSuggestion, invite, searchPeople, invitePerson, loadMembers, saveProfile, signOut, deleteAccount }: { household: Household; totes: Tote[]; email: string; profile: Profile; labelSize: LabelSize; setLabelSize: (size: LabelSize) => void; openTote: (t: Tote) => void; sendSuggestion: () => void; invite?: (email: string) => Promise<void>; searchPeople?: (query: string) => Promise<CloudPerson[]>; invitePerson?: (userId: string) => Promise<void>; loadMembers?: () => Promise<CloudMember[]>; saveProfile?: (name: string, username: string, discoverable: boolean, image?: string) => Promise<void>; signOut: () => void; deleteAccount?: () => void }) {
